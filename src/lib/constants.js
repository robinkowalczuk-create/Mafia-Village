...
export const ROLES = {
  villager: {
    ...
    camp: 'village',
    emoji: '🏡',
    image: null,  // → /src/assets/villager.png quand disponible
    color: '#2E5E4E',
    colorLight: '#3D7A64',
  ...
  littlegirl: {
    ...
    camp: 'village',
    emoji: '👁️',
    image: '/src/assets/littlegirl.png',
    color: '#8A6A3A',
    colorLight: '#AA8A5A',
  ...
  bodyguard: {
    ...
    camp: 'village',
    emoji: '🛡️',
    image: '/src/assets/bodyguard.png',
    color: '#4A4A8A',
    colorLight: '#6A6AAA',
